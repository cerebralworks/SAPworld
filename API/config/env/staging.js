 ...
 * to configure your Sails app for Staging.  The configuration in this file
 ...
 */
 ...
 env(__dirname+'/../../../.env');
console.log(process.env.STAGE_db_connection_string);
 module.exports = {
    conf: {
        google: {
        ...
        aws: {
            ...
            bucket_name: process.env.STAGE_aws_bucket_name,
            access_key_id: process.env.aws_access_key_id,
            secret_access_key: process.env.aws_secret_access_key,
            endpoint: process.env.aws_endpoint
        },
        solr: {
            host: process.env.STAGE_solr_host,
    ...
    /**************************************************************************
    *                                                                         *
    * Tell Sails what database(s) it should use in Staging.                *
    *                                                                         *
    ...
    **************************************************************************/
    datastores: {
      ...
      /***************************************************************************
      *                                                                          *
      * Configure your default Staging database.                              *
      *                                                                          *
      * 1. Choose an adapter:                                                    *
      ...
      ***************************************************************************/
      default: {
        ...
        url: process.env.STAGE_db_connection_string
    ...
    port: process.env.STAGE_service_port,
    ...
    models: {
      ...
      * strategy to "safe" when your app lifts in Staging mode.               *
    ...
    * > all environments (not just in Staging.)                            *
    *                                                                         *
    ***************************************************************************/
    blueprints: {
      shortcuts: false,
    ...
    ***************************************************************************/
    security: {
      ...
      *                                                                          *
      * > Replace "https://example.com" with the URL of your Staging server.  *
    ...
    /***************************************************************************
    *                                                                          *
    * Configure how your app handles sessions in Staging.                   *
    *                                                                          *
    * (https://sailsjs.com/config/session)                                     *
    *                                                                          *
    * > If you have disabled the "session" hook, then you can safely remove    *
    * > this section from your `config/env/Staging.js` file.                *
    *                                                                          *
    ***************************************************************************/
    session: {
      ...
      /***************************************************************************
      *                                                                          *
      * Staging session store configuration.                                  *
      *                                                                          *
      ...
      ***************************************************************************/
      ...
      //
      //--------------------------------------------------------------------------
		secret: 'f4642e2171f839f76f82736e6abfd358',


      /***************************************************************************
      *                                                                          *
      * Staging configuration for the session ID cookie.                      *
      *                                                                          *
      ...
      * > other options, you should always set `secure: true` in Staging      *
    ...
    /**************************************************************************
    *                                                                          *
    * Set up Socket.io for your Staging environment.                        *
    *                                                                          *
    ...
    ***************************************************************************/
    ...
    http: {
      ...
      /***************************************************************************
      *                                                                          *
      * The number of milliseconds to cache static assets in Staging.         *
    ...
    *                                                                         *
    * For the safety of your users' data, you should use SSL in Staging.   *
    ...
    **************************************************************************/
    ...
    /**************************************************************************
    *                                                                         *
    * Staging overrides for any custom settings specific to your app.      *
    * (for example, Staging credentials for 3rd party APIs like Stripe)    *
    *                                                                         *
