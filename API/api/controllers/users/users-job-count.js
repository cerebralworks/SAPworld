...
module.exports = async function list(request, response) {
	...
	CROSS JOIN json_array_elements(to_json(user_profile.hands_on_experience)) skills_id(skillses) 
