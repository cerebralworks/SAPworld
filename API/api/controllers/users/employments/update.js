...
module.exports = async function update(request, response) {
    ...
    //Update the employment record to db.
    const updateRecord = (post_data, callback) => {
        UserEmployments.update(id, post_data, async function(err, employment){
            if(err){
    ...
    validateModel.validate(UserEmployments, input_attributes, filtered_post_data, async function(valid, errors){
          if(valid){
              ...
              UserEmployments.findOne(query, async function(err, employment){
                  if(!employment){
                      _response_object.message = 'No employment details found with the given id.';
                      ...
                      await updateRecord(filtered_post_data, function (details) {
                          _response_object.message = 'Employment details has been updated successfully.';
