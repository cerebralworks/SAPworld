...
module.exports = async function create(request, response) {
	...
	const options = {
	  ...
	  headers: {
		...
		Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczovL2F1dGguY2FsZW5kbHkuY29tIiwiaWF0IjoxNjQzMjczNjA3LCJqdGkiOiI4MGI5MDg0NS0xNGFmLTQ1NDctYTRiMC1hZDZiNjZlM2M2ZmQiLCJ1c2VyX3V1aWQiOiJiZDRkYTA1Ny1iNDI1LTRlOTAtODEyMy1kZjk0ODZkZTgyNWIifQ.ZpsyRz8ENZ6E__IYst3hamrkYDLpS0Y_aCKFFXfk2J4'
	  }
	};
							...
							**/
							if(datas['application_status'] && datas['application_status'].length && datas['application_status'].length !=0){
								...
								if(data['canceled'] == true && (data['rescheduled'] != true && data['rescheduled'] != 'true') ){
									postDetailss.message= 'You have Canceled the '+titleName+' interview';
									...
									postDetailss.message= 'You have Scheduled the '+titleName+' interview';
									...
									postDetailss.message=  'You have Rescheduled the '+titleName+' interview';
